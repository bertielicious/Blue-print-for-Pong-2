...
{
    uchar pageHigh;     // page above : 8 bit data to be written will straddle two pages e.g 0 1, 1 2, 2 3, 3 4, 4 5 : above page = 0 or 1 or 2 or 3 or 4
    uchar pageLow;      // page below = 1 or 2 or 3 or 4 or 5
    uchar dataHigh;     // part of 8 bit data stored to high page
    uchar dataLow;      // part of 8 bit data stored to low page
    uchar data;         // decimal data need to be represented on LCD Nokia 5110
    uchar col;          // gameplay_area[row][col]]
    uchar row;
};        
...
bool screenBuffer [6][84] = {{0x00,0x00,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x031,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0xff},
